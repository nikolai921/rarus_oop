 ...
 * которые закрыты для внешнего использования, и доступны для потомков класса.
 *
 * Основные свойства:
 *
 ...
 * $queryParam;
 *
 * Реализована полноценная разборка Url, что позволяет расширять данный класс, другими методами в потомках.
 *
